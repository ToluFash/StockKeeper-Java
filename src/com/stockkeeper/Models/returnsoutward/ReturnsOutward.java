...
public class ReturnsOutward extends Account {


    public ReturnsOutward() {
        tickets = new HashMap<>();
        type ="Returns Outward Account";
    }

    public ReturnsOutward constructFromJson(String json) {
        ...
        try
        {
            ...
            for (int x = 0; x < Integer.parseInt(obj.get("entryLength").toString()); x++ ){
                ...
                TicketModel ticketModel = new TicketModel(entries, note, reference, date,1);
