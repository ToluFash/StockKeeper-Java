...
public class Purchases extends Account {

    public Purchases() {
        tickets = new HashMap<>();
        type ="Purchases Account";
    }

    public Purchases constructFromJson(String json) {
        ...
        try
        {
            ...
            for (int x = 0; x < Integer.parseInt(obj.get("entryLength").toString()); x++ ){
                ...
                String customer = ticket.get("supplier").toString();
