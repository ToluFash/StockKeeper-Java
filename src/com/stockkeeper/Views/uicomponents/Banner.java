...
public class Banner extends JLabel implements MouseMotionListener, ActionListener, MouseListener {
    ...
    public Banner(String title, String bannerText) {
        this.title = title;
    ...
    protected void paintComponent(Graphics g) {
        ...
        g2d.fillRect(1,1,getWidth()-1, 58);
        ...
        g2d.drawString(bannerText, x, 40);
    }
