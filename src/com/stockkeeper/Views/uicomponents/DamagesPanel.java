...
public class DamagesPanel extends JPanel implements  Details {
    ...
    public DamagesPanel(JLabel product, JLabel qty, JLabel title, JLabel entrySize, JLabel customer, JLabel time) {
