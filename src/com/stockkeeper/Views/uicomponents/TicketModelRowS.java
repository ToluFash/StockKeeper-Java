...
public class TicketModelRowS extends TicketDisplayItem implements MouseListener, Selectable {
    ...
    public TicketModelRowS(TicketModel entry) {
        super();
        this.ticket = entry;
